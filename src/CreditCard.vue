  ...
  <div class="vue-credit-card" :class="className">
    <div class="card-form-and-image" :style="{flexDirection: direction}">
      ...
      <div class="credit-card-form">
        <div class="field">
          <label for="nick-name">{{ trans.nickName.label }}</label>
          <input maxlength="20"
                 name="nick_name"
                 id="nick-name"
                 type="text"
                 :placeholder="trans.nickName.placeholder"
...
export default {
  ...
  computed: {
    ...
    fields() {
      return [this.form.nickName, this.form.name, this.form.cardNumber, this.form.expiration, this.form.security].join('');
    }
  },
  watch: {
    fields() {
